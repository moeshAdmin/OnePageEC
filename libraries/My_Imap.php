...
class My_Imap {
     ...
     */
    private function getBody($uid,$charset) {
     ...
     */
    function convertToUtf8($str,$charset=null) { 
        if($charset){
            $charset = $charset.",UTF-8,BIG5, ISO-8859-1, GBK";
        }else{
            $charset = "UTF-8,BIG5, ISO-8859-1, GBK";
        }
        echo utf8_decode($str);
        if(mb_detect_encoding($str, $charset)!="UTF-8"){
            $str = mb_convert_encoding($str, "UTF-8", mb_detect_encoding($str, $charset));
        }
